...
class KafkaProducerConfigTest {
    ...
    @Test
    void producerFactory_hasTheRequiredDurableJsonProducerConfiguration() {
        ...
        assertThat(properties).containsEntry(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka.example:9092")
                ...
                .containsEntry(JsonSerializer.TYPE_MAPPINGS,
                        "ticketEvent:com.am9.ticket_ingestion_service.messaging.TicketEvent");
    }
